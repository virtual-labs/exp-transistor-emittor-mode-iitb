function activity5() {
    ...
    pp.clearrightpannel();
    pp.addoffcanvas(3);
    pp.showtitle(`<p id="exp-title" style='width: 18vw;'>Study the Plot</span><p>`, 3);
    ...
    let parent = document.getElementById('t-5');
...
function load_questions() {
    ...
    let q1_obj = new Updated_Question(`The collector current I<sub>C</sub> is X times the base current, where is average value of X is ?`, [
        '10',
        '100',
        '1000',
        '10000'
